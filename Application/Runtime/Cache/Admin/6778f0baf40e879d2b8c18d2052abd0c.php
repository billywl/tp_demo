...
<link href="/Public/Css/left_css.css" rel="stylesheet"
	type="text/css">
</head>
...
<body bgcolor="16ACFF">
	<table width="98%" border="0" cellpadding="0" cellspacing="0"
		background="/Public/Images/Admin/tablemde.jpg">
		<tr>
			<td height="5" background="/Public/Images/Admin/tableline_top.jpg"
				bgcolor="#16ACFF"></td>
		</tr>
		<tr>
			<td>
				<TABLE width="97%" border=0 align=right cellPadding=0 cellSpacing=0
					...
					<TBODY>
						<TR>
							<TD height="25"
								style="background: url(/Public/Images/Admin/left_tt.gif) no-repeat">
							...
							<TD>
								<TABLE id=submenu1 cellSpacing=0 cellPadding=0 width="100%"
									...
									<TBODY>
										<TR>
											<TD width="2%">
												<IMG src="/Public/Images/Admin/closed.gif">
											</TD>
											<TD height=23>
												<A href="/admin.php/Category/add" target=main>添加分类</A>
											</TD>
										</TR>
										<TR>
											<TD>
											...
											<TD height=23>
												<A href="/admin.php/Category/admin" target=main>分类管理</A>
											</TD>
										</TR>
									</TBODY>
								</TABLE>
		...
		<tr>
			<td height="5" background="/Public/Images/Admin/tableline_bottom.jpg"
				bgcolor="#9BC2ED"></td>
		</tr>
		<tr>
			<td height="5" background="/Public/Images/Admin/tableline_top.jpg"
								...
								<table id="submenu2" cellspacing="0" cellpadding="0"
									...
									<tbody>
										<tr>
											...
											<td height="23">
												<a href="index.php?Admin/Brand/add" target="main">添加品牌</a>
											</td>
										</tr>
										...
										<tr>
											...
											<td height="23">
												<a href="index.php?Admin/Brand/admin" target="main">品牌管理</a>
											</td>
										</tr>
									</tbody>
								</table>
								...
								<TABLE id=submenu4 cellSpacing=0 cellPadding=0 width="100%"
									...
									<TBODY>
										...
										<TR>
											...
											<TD height=23>
												<A href="index.php?Admin/Goods/add" target=main>商品信息录入</A>
											</TD>
										</TR>
										<TR>
											<TD>
											...
											<TD height=23>
												<A href="index.php?Admin/Goods/admin" target=main>商品信息管理</A>
											</TD>
										</TR>
		...
		<tr>
			<td height="5" background="/Public/Images/Admin/tableline_bottom.jpg"></td>
		</tr>
	</table>
</body>
</html>