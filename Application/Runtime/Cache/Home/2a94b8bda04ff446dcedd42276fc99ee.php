...
<BODY>
	<!-- <DIV id=header>
		...
		<DIV class=logo>
			<A href="#">
				<IMG src="/Public/Images/Home/logo.gif">
			</A>
		</DIV>
		<DIV class=header_intro>
			<IMG src="/Public/Images/Home/by_top.gif">
		</DIV>
		<DIV class=headerdg>
			<EM>抢购热线（全天24小时） </EM>
			<P>
				<IMG src="/Public/Images/Home/tel1.gif">
			</P>
		</DIV>
	</DIV>
	<DIV id=nav>
	...
	<DIV id=min_div class=nav_min_div>
		<IMG src="/Public/Images/Home/top_min.jpg">
	</DIV>
	<DIV id=body>
		<DIV class=body_l>
			<DIV class=subsearch>
			...
			{if $value['level']==1}
				<DIV>
					...
					<SPAN class="right subnav_right">
						<IMG id=categorie_ico1 border=0 src="/Public/Images/Home/line.gif">
					</SPAN>
				</DIV>
			{/if}
				...
				<UL>
						...
						<DIV class=subinfo_body_top10_l>
							<A href="#">
								<IMG class=samllimg alt=""
									src="/Public/Images/Home/200905/thumb_img/3_thumb_G_1241422082679.jpg">
							</A>
						</DIV>
					...
					<LI>
						<DIV class=subinfo_body_top10_l>
							<A href="#">
								<IMG class=samllimg alt=""
									src="/Public/Images/Home/200905/thumb_img/24_thumb_G_1241971981429.jpg">
							</A>
						</DIV>
						<DIV class=subinfo_body_top10_r>
							<P class=subinfo_body_top10_r_1>
					...
					<LI>
						<DIV class=subinfo_body_top10_l>
							<A href="#">
								<IMG class=samllimg alt=""
									src="/Public/Images/Home/200905/thumb_img/12_thumb_G_1241965978410.jpg">
							</A>
						</DIV>
						<DIV class=subinfo_body_top10_r>
							<P class=subinfo_body_top10_r_1>
					...
					<LI>
						<DIV class=subinfo_body_top10_l>
							<A href="#">
								<IMG class=samllimg alt=""
									src="/Public/Images/Home/200905/thumb_img/9_thumb_G_1241511871555.jpg">
							</A>
						</DIV>
						<DIV class=subinfo_body_top10_r>
							<P class=subinfo_body_top10_r_1>
					...
					<LI>
						<DIV class=subinfo_body_top10_l>
							<A href="#">
								<IMG class=samllimg alt=""
									src="/Public/Images/Home/200905/thumb_img/22_thumb_G_1241971076803.jpg">
							</A>
						</DIV>
						<DIV class=subinfo_body_top10_r>
							<P class=subinfo_body_top10_r_1>
					...
					<LI>
						<DIV class=subinfo_body_top10_l>
							<A href="#">
								<IMG class=samllimg alt=""
									src="/Public/Images/Home/200905/thumb_img/20_thumb_G_1242106490058.jpg">
							</A>
						</DIV>
						<DIV class=subinfo_body_top10_r>
							<P class=subinfo_body_top10_r_1>
					...
					<LI>
						<DIV class=subinfo_body_top10_l>
							<A href="#">
								<IMG class=samllimg alt=""
									src="/Public/Images/Home/200905/thumb_img/8_thumb_G_1241425513488.jpg">
							</A>
						</DIV>
						<DIV class=subinfo_body_top10_r>
							<P class=subinfo_body_top10_r_1>
				...
				<LI>
					<A href="index.php?Home/Goods/show/id/<?php echo ($value['id']); ?>" target='_blank'>
						<IMG alt="<?php echo ($value['name']); ?>" width='100' height='100'
							src="/Public/Upload/Goods/<?php echo ($value['photo']); ?>">
					</A>
					<P class=pname>
	...
	<DIV class=footert>
		<DIV class=footertl>
			<DIV class=footert_1>
				<IMG src="/Public/Images/Home/logo21.gif">
			</DIV>
			<DIV class=footert_2>
				抢购热线（9:00-18:00）
				<P>
					<IMG src="/Public/Images/Home/tel2.gif">
				</P>
			</DIV>
		</DIV>
		<DIV class=footertr>
